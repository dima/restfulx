...
Gem::Specification.new do |s|
  ...
  s.date = %q{2008-11-26}
  s.description = %q{Ruboss Framework Rails 2.1+ and Merb 0.9.8+ Integration Support}
  ...
  s.has_rdoc = true
  s.homepage = %q{http://www.ruboss.com/framework}
  s.rdoc_options = ["--main", "README.rdoc"]
  s.require_paths = ["lib"]
  s.rubyforge_project = %q{ruboss4ruby}
  s.rubygems_version = %q{1.3.1}
  s.summary = %q{Ruboss Framework Rails 2.1+ and Merb 0.9.8+ Integration Support}
